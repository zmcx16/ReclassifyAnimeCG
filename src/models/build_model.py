...
from .torchvision_models.alexnet import alexnet
...
def build_default_model(num_classes, model_name):
    build_model_dict = {
        'alexnet': alexnet,
    ...
    if model_name in build_model_dict:
        return build_model_dict[model_name](num_classes=num_classes)
